...
/**
 * This is the model class for table "penilaian_kelurahan_c9".
 *
 * @property int $id
 ...
 * @property int $_2
 * @property int $_3
 * @property int $sub_total_kelurahan_c9
 *
 * @property PenilaianMasyarakatKelurahan $penilaianKemasyarakatanKelurahan
 */
class PenilaianKelurahanC9 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_penilaian_kemasyarakatan_kelurahan', '_1', '_2', '_3', 'sub_total_kelurahan_c9'], 'integer'],
            [['_1', '_2', '_3'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            '_2' => '2',
            '_3' => '3',
            'sub_total_kelurahan_c9' => 'Sub Total Kelurahan C9',
        ];
    }
    ...
    public function sumC9(){
        ...
        $this->sub_total_kelurahan_c9 = $sumC9;
        return $sumC9;
    }
}
