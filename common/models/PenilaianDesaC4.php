...
/**
 * This is the model class for table "penilaian_desa_c4".
 *
 * @property int $id
 ...
 * @property int $_23
 * @property int $_24
 * @property int $sub_total_desa_c4
 *
 * @property PenilaianMasyarakatDesa $penilaianKemasyarakatanDesa
 */
class PenilaianDesaC4 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function attributeLabels()
    {
        return [
            ...
            '_23' => '23',
            '_24' => '24',
            'sub_total_desa_c4' => 'Sub Total Desa C4',
        ];
    }
