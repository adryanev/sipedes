...
/**
 * This is the model class for table "penilaian_kelurahan_a4".
 *
 * @property int $id
 ...
 * @property int $_10
 * @property int $_11
 * @property int $sub_total_kelurahan_a4
 *
 * @property PenilaianWilayahKelurahan $penilaianWilayahKelurahan
 */
class PenilaianKelurahanA4 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_penilaian_wilayah_kelurahan', '_1', '_2', '_3', '_4', '_5', '_6', '_7', '_8', '_9', '_10', '_11', 'sub_total_kelurahan_a4'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            '_10' => '10',
            '_11' => '11',
            'sub_total_kelurahan_a4' => 'Sub Total Kelurahan A4',
        ];
    }
    ...
    public function sumA4(){
        $sumA4 = $this->_1
            ...
            +$this->_10
            +$this->_11;
        $this->sub_total_kelurahan_a4 = $sumA4;
        return $sumA4;
    }
}
